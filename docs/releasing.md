...
2. Smoke-test the 150 ms hover open, delayed close, click-to-pin, `Esc`, drag, edge snap, language switch, always-on-top toggle, reset-credit popover, refresh, tray, offline/cache, and login states on Windows and macOS.
